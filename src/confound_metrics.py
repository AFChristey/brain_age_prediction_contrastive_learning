...
datasets = {
    ...
    "Exponential_DR": ("/rds/user/afc53/hpc-work/saved_features/Exponential_DR/features_before_reduction_epoch_50.npy",
                        "/rds/user/afc53/hpc-work/saved_features/Exponential_DR/metadata_epoch_50.npy"),
    "Exponential_Stiffness": ("/rds/user/afc53/hpc-work/saved_features/Exponential_Stiffness/features_before_reduction_epoch_50.npy",
                              "/rds/user/afc53/hpc-work/saved_features/Exponential_Stiffness/metadata_epoch_50.npy"),
    "Exponential_T1": ("/rds/user/afc53/hpc-work/saved_features/Exponential_T1/features_before_reduction_epoch_50.npy",
                        "/rds/user/afc53/hpc-work/saved_features/Exponential_T1/metadata_epoch_50.npy"),
    "RankN_DR": ("/rds/user/afc53/hpc-work/saved_features/RankN_DR/features_before_reduction_epoch_50.npy",
                 "/rds/user/afc53/hpc-work/saved_features/RankN_DR/metadata_epoch_50.npy"),
    "RankN_Stiffness": ("/rds/user/afc53/hpc-work/saved_features/RankN_Stiffness/features_before_reduction_epoch_50.npy",
                        "/rds/user/afc53/hpc-work/saved_features/RankN_Stiffness/metadata_epoch_50.npy"),
    "RankN_T1": ("/rds/user/afc53/hpc-work/saved_features/RankN_T1/features_before_reduction_epoch_50.npy",
                 "/rds/user/afc53/hpc-work/saved_features/RankN_T1/metadata_epoch_50.npy"),
}
