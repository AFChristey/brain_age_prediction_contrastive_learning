...
def load_data(opts):
    ...
    train_dataset = OpenBHB(modality='dr', train=True, transform=T_train, label=opts.label, path=opts.path, fold=4)
    ...
    train_dataset_score = OpenBHB(modality='dr', train=True, transform=T_train, label=opts.label, path=opts.path, fold=4)
    ...
    test_dataset = OpenBHB(modality='dr', train=False, transform=T_test, path=opts.path, fold=4)
